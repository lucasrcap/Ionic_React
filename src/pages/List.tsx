...
const List: React.FC = () => {
  ...
  const [selectedUser, setSelectedUsers] = useState<any>(null);
  ...
  useIonViewWillEnter(() => {
    const showUsers = async () => {
      ...
      console.log(
        "🚀 ~ file: List.tsx:10 ~ useIonViewWillEnter ~ users:",
        users
      );
      setUsers(users);
      setLoading(false);
    ...
    <IonPage ref={page}>
      ...
      <IonContent>
        ...
        {users.map((user, index) => (
          <IonCard key={index} onClick={() => setSelectedUsers(user)}>
            <IonCardContent className="ion-no-padding">
              <IonItem lines="none">
                <IonAvatar slot="start">
        ...
        <IonModal
          ...
          onIonModalDidDismiss={() => setSelectedUsers(null)}
        >
          <IonHeader>
